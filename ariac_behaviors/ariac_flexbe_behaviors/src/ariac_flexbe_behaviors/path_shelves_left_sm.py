...
'''
class Path_Shelves_LeftSM(Behavior):
	'''
	...
	def __init__(self):
		super(Path_Shelves_LeftSM, self).__init__()
		self.name = 'Path_Shelves_Left'
	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('ComputePick',
										...
										remapping={'move_group': 'move_group_left', 'move_group_prefix': 'move_group_prefix', 'tool_link': 'tool_link', 'pose': 'part_pose', 'offset': 'offset', 'rotation': 'rotation', 'joint_values': 'joint_values', 'joint_names': 'joint_names'})
